...
function Navbar() {
  ...
  return (
    <div className="grid grid-cols-6 lg:grid-cols-14 relative h-[50px] z-10 drop-shadow-lg text-[#ba8107] bg-[#212122]">
        <h1 className="font-bold text-[20px] lg:text-[27px] w-[400px] mt-[5px] ml-[5px] md:mr-0">
          Istimewa Coffee
        </h1>
      <div className="col-start-6 col-end-6 tab:col-start-6 tab:col-end-6 md:col-start-5 md:col-end-7 lg:col-start-8 xl:col-start-9 lg:col-end-15 xl:col-end-15 flex gap-[30px] items-center justify-end mr-[50px] ">
        <ul className="hidden md:flex gap-[20px] text-[20px] lg:text-[15px]">
      ...
      {isDesktop ? null : (<div className={!nav ? "hidden" : "flex flex-col gap-[10px] text-center font-semibold text-[30px] w-screen h-screen absolute top-0 p-[20px] pt-[80px] bg-[#000000f7] z-20"}>
        ...
        <Link className="w-full cursor-pointer hover:opacity-[0.7]" onClick={handleClose} to="promo" smooth={true} offset={0} duration={500}>ABOUT</Link>
