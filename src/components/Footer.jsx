    ...
    return (
        <div className="w-full">
            <div className="flex flex-col gap-[20px] w-full py-4 justify-between text-center bg-[#212122] px-[50px] -mt-[1px]">
                <h1 className="text-gray-300 text-[30px]">Hi</h1>
                <p className="text-gray-500 max-w--[700px] mx-auto my-[10px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore suscipit quidem ipsum sint deleniti? Quae nulla, accusamus qui amet quibusdam consectetur aut ea magni distinctio aliquid laudantium ducimus quas ad!</p>
